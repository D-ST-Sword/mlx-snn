...
snntorch_baselines <- tribble(
  ...
  "Exp 1",     "Leaky",              97.34,     0.05,
  "Exp 1",     "RLeaky (V=0.5)",     68.08,     5.64,
  "Exp 1",     "Synaptic",           95.76,     0.10,
  "Exp 1",     "RSynaptic (V=0.5)",  52.24,     13.26,
  "Exp 2",     "baseline",           97.34,     0.05,
  "Exp 2",     "learn_beta",         96.94,     0.07,
  "Exp 2",     "learn_thresh",       97.24,     0.03,
  "Exp 2",     "learn_both",         97.23,     0.11,
  "Exp 3",     "fast_sigmoid",       96.69,     0.13,
  "Exp 3",     "arctan",             97.34,     0.05,
  "Exp 3",     "sigmoid",            9.91,      0.13,
  "Exp 3",     "triangular",         50.79,     0.46,
  "Exp 3",     "straight_through",   66.01,     1.07,
  "Exp 4",     "ce_rate",            97.34,     0.05,
  "Exp 4",     "ce_count",           97.29,     0.19,
  "Exp 4",     "mse_membrane",       96.78,     0.12,
  "Exp 5",     "rate",               97.34,     0.05,
  "Exp 5",     "latency",            94.48,     0.03,
  "Exp 5",     "delta",              81.91,     0.51
) %>%
